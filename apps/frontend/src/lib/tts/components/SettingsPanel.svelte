...
<aside
  class="rounded-xl border border-slate-800 bg-slate-900/70 p-6 shadow-2xl shadow-slate-950/40 backdrop-blur"
>
  <p class="text-sm font-medium uppercase tracking-[0.18em] text-slate-400">
    {UI_TEXT.configurationsEyebrow}
  </p>
  <h2 class="mt-2 text-2xl font-semibold text-white">
    {mode === 'clone' ? UI_TEXT.cloneSettingsTitle : UI_TEXT.settingsTitle}
  </h2>

  <div class="mt-2 space-y-5">
    <SelectField
      id="mode-select"
      label={UI_TEXT.modeLabel}
