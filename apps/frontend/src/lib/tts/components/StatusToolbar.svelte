...
<div class="flex flex-wrap items-center justify-end gap-2">
	...
	<Button type="button" variant="secondary" size="small" class="px-4" onclick={onLoadModel} disabled={isBusy || modelReady}>
	...
	<Button type="button" variant="danger" size="small" class="px-4" onclick={onUnloadModel} disabled={isBusy || !modelReady}>
