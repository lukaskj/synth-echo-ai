import type {LanguageOption, RequestStatus, TtsFormState, TtsMode, VoiceCategoryOption} from "./types";
...
export const MODE_OPTIONS: { value: TtsMode; label: string; description: string }[] = [
  { value: "synthesize", label: "Text to speech", description: "Generate a voice from text and instruct settings." },
  { value: "clone", label: "Voice cloning", description: "Generate speech from a reference voice sample." },
];
...
export const UI_TEXT = {
  ...
  speechRecognitionNotSupported: "Speech recognition is not supported in this browser. Enter the transcript manually.",
